 ...
 * honey quotation glyph breaking the margin, and a drawn rule to close.
 */
  ...
  return (
    <Section spacing="lg">
      <Container size="prose" className="relative">
        <span
          aria-hidden="true"
          className="pointer-events-none absolute -top-12 left-1 select-none font-display text-[8rem] leading-none text-honey/30 sm:-left-16 sm:-top-8 sm:text-[10rem]"
        >
          &ldquo;
        </span>
