    ...
    return (
      ...
      >
        <div className="relative min-h-64 overflow-hidden md:min-h-full">
          ...
          />
          <span className="absolute left-5 top-5 rounded-full bg-paper/90 px-3.5 py-1.5 text-xs font-medium text-pine backdrop-blur">
            {post.category}
          </span>
        </div>
        <div className="flex flex-col justify-center p-7 sm:p-10">
          <Meta post={post} />
          <h3 className="mt-4 font-display text-[clamp(1.5rem,2.6vw,2.1rem)] leading-[1.15] text-pine">
    ...
    return (
      ...
      >
        ...
        <div className="min-w-0">
          <Meta post={post} />
          <h3 className="mt-2 line-clamp-2 font-display text-lg leading-snug text-pine">
            <span className="link-underline group-hover:bg-[length:100%_1px]">
              {post.title}
            </span>
          </h3>
